...
public abstract class EproBaseSectionListFragment extends EproBaseFragment implements
		OnItemClickListener {

	private static final String LOG_TAG = "EproBaseSectionListFragment";
	...
	public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState) {
		...
		// ビューの作成
		final View view = inflater.inflate(R.layout.epro_base_list_fragment_with_section, container, false);

		// ビューを取得
		mProgressContainer = (RelativeLayout) view.findViewById(R.id.epro_base_list_fragment_with_section_progress_container);
		mProgressBar = (ProgressBar) mProgressContainer.findViewById(R.id.epro_base_list_fragment_with_section_progress_bar);
		mListViewContainer = (RelativeLayout) view.findViewById(R.id.epro_base_list_fragment_with_section_list_view_container);
		mTvEmpty = (TextView) mListViewContainer.findViewById(R.id.epro_base_list_fragment_with_section_tv_empty);
		mListView = (AmazingListView) mListViewContainer.findViewById(R.id.epro_base_list_fragment_with_section_list_view);
	...
	public void setListAdapter(final ListAdapter adapter) {
		...
		final boolean hadAdapter = (adapter != null);
		mAdapter = adapter;
		if (mListView != null && hadAdapter) {
