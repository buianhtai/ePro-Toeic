...
import com.mZone.epro.toeic.customView.TextJustifyUtils;
...
{       
    ...
    public void setText(SpannableStringBuilder st)
    {
        wrapEnabled = false;
        super.setText(st);
    }
    public void setText(SpannableStringBuilder st, BufferType type)
    {
        wrapEnabled = false;
        super.setText(st, type);
    }
