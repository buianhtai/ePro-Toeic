...
public class ToeicFragmentRowContentPart_3 extends ToeicFragmentRowAbstract implements OnStateChangedListener {
	...
	public ToeicFragmentRowContentPart_3() {
		// TODO Auto-generated constructor stub
	}

	public ToeicFragmentRowContentPart_3(int partIndex) {
		super(partIndex);
		// TODO Auto-generated constructor stub
	}
...
//		Log.e("test", "set radioselect " + String.valueOf(rowID));
		if (radioGroupsArray == null) return;
		for (int i = 0; i < radioGroupID.length; i++){
			if (radioGroupsArray[i] != null){
				int questionID = dataController.getQuestionID(ToeicDataController.TOEIC_PART_3, rowID, i) - 1;
				...
				radioGroupsArray[i].setText(dataController.getListeningQuestion(ToeicDataController.TOEIC_PART_3, rowID, i));
			}
		}
	}
