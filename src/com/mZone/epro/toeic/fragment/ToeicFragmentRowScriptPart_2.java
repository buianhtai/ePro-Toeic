...
public class ToeicFragmentRowScriptPart_2 extends ToeicFragmentRowAbstract implements ToeicMediaListenerObserver{

	private int[] textViewID = {R.id.rowScriptQ, R.id.rowScriptA, R.id.rowScriptB, R.id.rowScriptC};
	private CustomWordClickableScriptTextview[] textViewArray = new CustomWordClickableScriptTextview[textViewID.length];
	public ToeicFragmentRowScriptPart_2() {
		// TODO Auto-generated constructor stub
	}

	public ToeicFragmentRowScriptPart_2(int partIndex, ToeicMediaListener listener) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.toeic_fragment_listview_rowpager_script_part_2, container, false);
