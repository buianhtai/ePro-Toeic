...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    {
    	int getIconId(int position, int active);
    }

    private int TITLE_OFFSET_DIPS = 24;
    private int TAB_VIEW_PADDING_DIPS = 16;
    ...
    ArrayList<View> tabViewArray;
    private CustomTabInterface mCustomTabDelegate;
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TITLE_OFFSET_DIPS = context.getResources().getInteger(R.integer.tittle_offset_dip);
        TAB_VIEW_PADDING_DIPS = context.getResources().getInteger(R.integer.tabview_padding_dip);
        TAB_VIEW_TEXT_SIZE_SP = context.getResources().getInteger(R.integer.tabview_textsize_sp);
        mTitleOffset = (int) (TITLE_OFFSET_DIPS * getResources().getDisplayMetrics().density);
       

        mTabStrip = new SlidingTabStrip(context);
        tabViewArray = new ArrayList<View>();
...
//        textView.setBackgroundColor(Color.WHITE);
	...
	public void centerTabItem(int tabIndex) {
        final int tabStripChildCount = mTabStrip.getChildCount();
        if (tabStripChildCount == 0 || tabIndex < 0 || tabIndex >= tabStripChildCount) {
            return;
        }
        View selectedChild = mTabStrip.getChildAt(tabIndex);
        if (selectedChild != null) {
        	final int screenWidth = getDisplay().getWidth();
        	final int leftX = selectedChild.getLeft();
        	int newX = 0;
      	
	        newX = leftX + (selectedChild.getWidth() / 2) - (screenWidth / 2);
	        if (newX < 0) {
	            newX = 0;
	        }
    ...
    /**
     * Set CustomTab Delegate
     */
    public void setCustomTabDelegate(CustomTabInterface delegate){
    	this.mCustomTabDelegate = delegate;
    }
